...
const byte MAX7219_Dot_Matrix_font [256] [8] PROGMEM = {
  ...
  { 0x0E, 0x60, 0x03, 0x38, 0x06, 0x70, 0x07, 0x00 }, // '#' rain icon
  { 0x49, 0x2A, 0x1C, 0x77, 0x1C, 0x2A, 0x49, 0x00 }, // '$' snow icon
  { 0x0A, 0x20, 0x05, 0x28, 0x02, 0x50, 0x25, 0x00 }, // '%' fog icon
  { 0x1C, 0x22, 0x41, 0x41, 0x41, 0x22, 0x1C, 0x00 }, // '&' clear icon
  { 0x38, 0x44, 0x44, 0x48, 0x50, 0x48, 0x30, 0x00 }, // ''' clouds icon
